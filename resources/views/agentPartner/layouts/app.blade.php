...
<head>
    ...
    <!-- Admin JS -->
    <script type="text/javascript" src="{{ URL::asset('js/custom/agentPartner.js') }}"></script>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{ url('agentPartner/dashboard') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
