...
.success-message { color: #f00; font-size: 30px; font-weight: 300; padding: 15px 0; }
...
.number i { color: #1bbc28; padding-left: 10px; }
...
<div class="sucessfull-payment">
 <div class="paymenet-box">
  ...
  <div class="success-message">Payment Cancellation!</div>
