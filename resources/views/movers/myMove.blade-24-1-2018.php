  ...
  <div class="modal-content">
   <div class="modal-body">
    ...
    <div class="row">
     <div class="col-sm-8 col-md-8 col-lg-8">&nbsp;</div>
     <div class="col-sm-4 col-md-4 col-lg-4 text-right"> 
     	<a href="javascript:void(0);" id="btn_prev_mailbox_keys" class="btn"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Previous</a>
     	<a href="javascript:void(0);" id="btn_next_mailbox_keys" class="btn">Next <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
	</div>
    </div>
   </div>
