...
<section class="percentage-section">
 <div class="container">
  <div class="percentage-bar">
   ...
   <div class="progress">
    <div class="progress-bar" role="progressbar" id="activity_progress_bar" aria-valuenow="{{ $completedActivitiesPercentage }}" aria-valuemin="0" aria-valuemax="100" style="width:{{ $completedActivitiesPercentage }}%"> <span class="sr-only"><span id="activity_progress2">{{ $completedActivitiesPercentage }}</span>% Complete</span> </div>
   </div>
  </div>
 </div>
</section>
    ...
    <div class="col-xs-6 col-lg-4">
     <div class="boxes">
      <div class="img-icon"> 
       ...
       <img src="{{ ($activity->image_name !='' ) ? url('/images/activities/' . $activity->image_name) : url('/images/activity_image_not_found.png') }}" class="center-block" alt=""> </div>
      <div class="box-title">
       <h3>{{ ucwords( strtolower( $activity->activity ) ) }}</h3>
      </div>
      <div class="pophover-icon">
       <ul class="popover-icon-group activities_container">
        <li> <a href="javascript:void(0);" title="Get started" id="{{ $activity->id }}" class="{{ $activity->activity_class }} done_activity">
         <?php
												...
												?>
         <i class="{{ $icon1 }}" aria-hidden="true"></i> </a> </li>
        <li><a href="javascript:void(0);" title="Do it later" class=""><i class="fa fa-history" aria-hidden="true"></i></a></li>
        <li> <a href="javascript:void(0);" title="Discard" class="discard_activity" id="{{ $activity->id }}"> <i class="{{ $icon2 }}" aria-hidden="true"></i> </a> </li>
        <li>
  ...
  <div class="row">
   <div class="col-md-4">
    <div class="user-name-review">
     <div class="user-short-name"> <span>{{ $agentInitials }}</span>
      <p>{{ $agentName }}</p>
     </div>
    </div>
   </div>
   <div class="col-md-8">
    <div class="reciew-box">
     ...
     <span id="agent_average_rating">( {{ $agentRating or 0 }} Rating )</span> </div>
   </div>
  </div>
 </div>
   ...
   <div class="row">
    <div class="col-md-12">
     <div class="comment-area">
      <h2>Hi {{ $agentName }},</h2>
      <p id="agent_rating_message_container"> I appreciate you work and want to say thank you. </p>
   ...
   <div class="row">
    <div class="col-md-12">
     <div class="user-comment-info">
      <div class="col-md-8">
       <div class="comment-group-left">
        <ul class="comment-group">
         <li> <a href="javascript:void(0);" class="agent_helpful" data-status="{{ $agentClientHelpfulCount }}"> <i class="fa fa-thumbs-up" aria-hidden="true" style="{{ ( $agentClientHelpfulCount == 1 ) ? 'color: green' : '' }}"></i><span class="agent_helpful_count">{{ $agentHelpfulCount }}</span> Helpful </a> </li>
      ...
      <div class="col-md-4">
       <div class="user-name-section user-pro-coment"> <strong>Share this with :</strong> <img src="{{ ( $agentDetails->image != '' ) ? url('/images/agents/' . $agentDetails->image) : url('/images/movers/user-avtar.png') }}" class="user-avtar" alt="Udistro" height="50px" width="50px">
        <div class="username">
         <h3>{{ $agentName }}</h3>
        </div>
       </div>
     ...
     <div class="col-md-12">
      <div class="text-center">
       <label id="agent_rating-error" class="error" for="agent_rating"></label>
      </div>
...
<div id="home_cleaning_services_modal" class="modal fade mover-modal">
 <div class="modal-dialog modal-lg"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
    ...
    <div class="row">
     ...
     <div class="col-sm-9 col-md-9 col-lg-9" id="home_cleaning_services_step1">
      <div> <strong>Moving to a new neighborhood, and you need someone to clean your old apartment, or new house before you move in. Anything you need do on home cleaning service service starts here</strong> </div>
      <br>
      <div>
        ...
        <div class="panel-group" id="accordion">
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse1">Indicate type of cleaning</a> </h4>
          </div>
           ...
           <div class="panel-body">
            <div>
             <label>
              ...
              Move in cleaning</label>
            </div>
            <div>
             <label>
              <input type="checkbox" name="">
              Move out cleaning</label>
            </div>
           </div>
          </div>
         </div>
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse2">Moving From</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse3">Moving To</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse4">Detailed Job Description</a> </h4>
          </div>
          <div id="home_cleaning_services_collapse4" class="panel-collapse collapse">
           <div class="panel-body">
            ...
            <div class="form-group">
             ...
             <label class="form-group">
              <input type="radio" name="">
              1500-2500 sqft</label>
             <label class="form-group">
              <input type="radio" name="">
              above 2500 sqft</label>
            </div>
            <div class="form-group">
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse5">Additional Services</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse6">Call Me On</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_cleaning_services_collapse7">Additional Information (If Any)</a> </h4>
          </div>
    ...
    <div class="row">
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div class="helpful-box">
       <label>Is this helpful to you?</label>
       <a href="javascript:void(0);" id="1" data-activity="home_cleaning_services" class="activity_feedback">Yes</a> <a href="javascript:void(0);" id="0" data-activity="home_cleaning_services" class="activity_feedback">No</a> </div>
     </div>
     <div class="col-sm-4 col-md-4 col-lg-4 text-right"> <a href="javascript:void(0);" id="btn_prev_home_cleaning_services" class="btn"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Previous</a> <a href="javascript:void(0);" id="btn_next_home_cleaning_services" class="btn">Next <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
    </div>
   </div>
   <!-- <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div id="moving_companies_modal" class="modal fade mover-modal">
 <div class="modal-dialog modal-lg"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
      ...
      <div>
       <form name="frm_home_moving_companies" id="frm_home_moving_companies">
        <div class="panel-group" id="accordion">
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse1">Indicate type of cleaning</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse2">Moving From</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse3">Moving To</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse4">Detailed Job Description</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse5">Additional Services</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse6">Call Me On</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#home_moving_companies_collapse7">Additional Information (If Any)</a> </h4>
          </div>
    ...
    <div class="row">
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div class="helpful-box">
       <label>Is this helpful to you?</label>
       <a href="javascript:void(0);" id="1" data-activity="moving_companies" class="activity_feedback">Yes</a> <a href="javascript:void(0);" id="0" data-activity="moving_companies" class="activity_feedback">No</a> </div>
     </div>
     <div class="col-sm-4 col-md-4 col-lg-4 text-right"> <a href="javascript:void(0);" id="btn_prev_home_moving_companies" class="btn"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Previous</a> <a href="javascript:void(0);" id="btn_next_home_moving_companies" class="btn">Next <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
    </div>
   </div>
   <!-- <div class="modal-footer">
	        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div id="tech_concierge_modal" class="modal fade mover-modal">
 <div class="modal-dialog modal-lg"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
      ...
      <div>
       <form name="frm_tech_concierge" id="frm_tech_concierge">
        <div class="panel-group" id="accordion">
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse1">Indicate type of cleaning</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse2">Moving From</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse3">Moving To</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse4">Detailed Job Description</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse5">Additional Services</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse6">Call Me On</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#tech_concierge_collapse7">Additional Information (If Any)</a> </h4>
          </div>
    ...
    <div class="row">
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div class="helpful-box">
       <label>Is this helpful to you?</label>
       <a href="javascript:void(0);" id="1" data-activity="tech_concierge" class="activity_feedback">Yes</a> <a href="javascript:void(0);" id="0" data-activity="tech_concierge" class="activity_feedback">No</a> </div>
     </div>
     <div class="col-sm-4 col-md-4 col-lg-4 text-right"> <a href="javascript:void(0);" id="btn_prev_tech_concierge" class="btn"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Previous</a> <a href="javascript:void(0);" id="btn_next_tech_concierge" class="btn">Next <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
    </div>
   </div>
   <!-- <div class="modal-footer">
	        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div id="cable_internet_services_modal" class="modal fade mover-modal">
 <div class="modal-dialog modal-lg"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
    ...
    <div class="row">
	 ...
	 <div class="row">
      <div class="col-sm-12"> <p>Moving to a new neighborhood, and you need someone to clean your old apartment, or new house before you move in. Anything you need do on home cleaning service service starts here</p> </div>
	  </div>
	  <div class="clearfix"></div>
      <div>
       <form name="frm_cable_internet_services" id="frm_cable_internet_services">
        <div class="panel-group" id="accordion">
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse1">Indicate type of cleaning</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse2">Moving From</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse3">Moving To</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse4">Detailed Job Description</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse5">Additional Services</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse6">Call Me On</a> </h4>
          </div>
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
           <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#cable_internet_services_collapse7">Additional Information (If Any)</a> </h4>
          </div>
    ...
    <div class="row">
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div class="helpful-box">
       <label>Is this helpful to you?</label>
       <a href="javascript:void(0);" id="1" data-activity="cable_internet_services" class="activity_feedback">Yes</a> <a href="javascript:void(0);" id="0" data-activity="cable_internet_services" class="activity_feedback">No</a> </div>
     </div>
     <div class="col-sm-4 col-md-4 col-lg-4 text-right"> <a href="javascript:void(0);" id="btn_prev_cable_internet_services" class="btn"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Previous</a> <a href="javascript:void(0);" id="btn_next_cable_internet_services" class="btn">Next <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
    </div>
   </div>
   <!-- <div class="modal-footer">
	        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div id="share_announcement_modal" class="modal fade mover-modal">
 <div class="modal-dialog modal-lg"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
    ...
    <div class="row">
     <div class="col-sm-4 col-md-4 col-lg-4"> <img src="{{ url('/images/house_sold.png') }}" height="200" width="250" alt="udistro"> </div>
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div> <strong>The {{ ucwords( strtolower( $clientName ) ) }} are moving!</strong> </div>
      <br>
      <div>
    ...
    <div class="row">
     <div class="col-sm-4 col-md-4 col-lg-4">
      <div class="">
       ...
       <span>( {{ $agentRating }} Rating )</span> </div>
     </div>
     <div class="col-sm-8 col-md-8 col-lg-8">
      <div class="row">
       <div class="col-sm-6 col-md-6 col-lg-6"> <img src="{{ ( $companyDetails->image != '' ) ? url('/images/company/' . $companyDetails->image) : url('/images/movers/company_icon.png') }}" height="60px" width="60px" alt="Udistro" />
        <div> {{ ucwords( strtolower( $companyDetails->company_name ) ) }} </div>
        <div> {{ ucwords( strtolower( $companyDetails->address ) ) }}, {{ $companyProvince->name }}, {{ $companyCity->name }}, {{ $companyDetails->postal_code }} </div>
       </div>
       <div class="col-sm-6 col-md-6 col-lg-6"> <img src="{{ ( $agentDetails->image != '' ) ? url('/images/agents/' . $agentDetails->image) : url('/images/movers/user-avtar.png') }}" class="user-avtar" alt="Udistro" height="50px" width="50px">
        <div> {{ $agentName }} </div>
       </div>
      </div>
     </div>
    ...
    <div class="row">
     ...
     <div class="col-sm-4 col-md-4 col-lg-4"> Share this on: <i class="fa fa-facebook-square"></i> <i class="fa fa fa-twitter-square"></i> <i class="fa fa fa-google-plus-square"></i> <i class="fa fa fa-linkedin-square"></i> </div>
    </div>
   </div>
  </div>
 </div>
...
<!-- <div id="user_response_modal" class="modal fade mover-modal">
...
<div id="confirmation_modal" class="modal fade mover-modal">
 <div class="modal-dialog"> 
  <!-- Modal content-->
  <div class="modal-content">
   <div class="modal-body">
    ...
    <div> Have you completed all the task? </div>
   </div>
   <div class="modal-footer">
