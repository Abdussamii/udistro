<?php $__env->startSection('title', 'Udistro'); ?>
...
<section class="content-section video-section">
  <div class="video_bg">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="logo_banner"><img src="<?php echo e(url('/') . '/images/logo.png'); ?>" class="center-block img-responsive" alt="udistro"></div>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="serviceBox">
          <div class="serviceIcon text-center"><img src="<?php echo e(url('/') . '/images/mail-icon.png'); ?>" alt="Mail Icon"/></div>
      ...
      <div class="col-md-3">
        <div class="serviceBox">
          <div class="serviceIcon text-center"><img src="<?php echo e(url('/') . '/images/add_icon.png'); ?>" alt="Address"/></div>
      ...
      <div class="col-md-3">
        <div class="serviceBox">
          <div class="serviceIcon text-center"><img src="<?php echo e(url('/') . '/images/connect_icon.png'); ?>" alt="Connect"/></div>
      ...
      <div class="col-md-3">
        <div class="serviceBox">
          <div class="serviceIcon text-center"><img src="<?php echo e(url('/') . '/images/update_icon.png'); ?>" alt="Update"/></div>
        ...
        <ul class="timeline">
          <li class="first-step">
            ...
            <div class="steps stepsOne timeline-panel">
              <div class="media">
                <div class="media-left"> <a href="#"> <img class="media-object" src="<?php echo e(url('/') . '/images/step_one.png'); ?>" alt="Steps One"> </a> </div>
          ...
          <li class="first-step">
            ...
            <div class="steps stepsOne timeline-panel timeline-inverted">
              <div class="media">
                <div class="media-left pull-right"> <a href="#"> <img class="media-object" src="<?php echo e(url('/') . '/images/step_two.png'); ?>" alt="Steps One"> </a> </div>
          ...
          <li class="first-step">
            ...
            <div class="steps stepsOne timeline-panel">
              <div class="media">
                <div class="media-left"> <a href="#"> <img class="media-object" src="<?php echo e(url('/') . '/images/step_three.png'); ?>" alt="Steps One"> </a> </div>
                <div class="media-body">
          ...
          <li class="first-step">
            ...
            <div class="steps stepsOne timeline-panel timeline-inverted">
              <div class="media">
                <div class="media-left pull-right"> <a href="#"> <img class="media-object" src="<?php echo e(url('/') . '/images/step_four.png'); ?>" alt="Steps One"> </a> </div>
                <div class="media-body media-body-right">
	            		...
	            		<div class="col-md-4">
			                <div class="panel panel-danger light-seegreen">
			                  <div class="panel-heading">
			                    <h3 class="text-center"><?php echo e(ucwords(strtolower($plan->plan_name))); ?></h3>
			                    <!-- <p class="text-center plan">Trial Plan</p> -->
			                  </div>
			                  <ul class="list-group list-group-flush text-center">
			                    <li class="list-group-item">1-<?php echo e($plan->number_of_emails); ?> Email per user per month</li>
			                  ...
			                  <div class="panel-body text-center">
			                    ...
			                    <strong><span class="dollor">$</span><span class="price-d"><?php echo e($plan->plan_charges); ?></span><br>
			                    <p class="monthly"><?php echo e($plan->validity_days . ' days'); ?></p>
			                    </strong>
			                    </p>
			                  </div>
...
<?php echo $__env->make('movers.layouts.app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>