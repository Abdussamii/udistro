					...
					<form class="form-horizontal" role="form" name="frm_agent_profile" id="frm_agent_profile">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
								  	<!-- <textarea class="form-control autocomplete" name="agent_address" id="agent_address"><?php echo e(isset($agentDetails->address) ? $agentDetails->address : ''); ?></textarea> -->
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
								  	<input class="form-control" type="text" value="<?php echo e(isset($agentDetails->facebook) ? $agentDetails->facebook : ''); ?>" name="agent_facebook" id="agent_facebook">
								</div>
							</div>
							<div class="form-group">
