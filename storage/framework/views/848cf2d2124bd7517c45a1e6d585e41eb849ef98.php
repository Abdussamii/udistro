...
<head>
    ...
    <!-- Admin JS -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/custom/agent.js')); ?>"></script>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo e(url('agent/dashboard')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('agent/profile')); ?>"><i class="fa fa-user" aria-hidden="true"></i> Profile</a>
                        </li>
                        <li <?php echo ( ( Request::path() == 'agent/clients' ) ? 'class="active"' : '' ) ?> >
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo e(url('/agent/clients')); ?>">Clients</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
