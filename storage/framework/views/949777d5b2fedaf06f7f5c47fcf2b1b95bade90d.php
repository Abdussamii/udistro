...
<!-- Bootstrap -->
<link href="<?php echo e(URL::asset('css/movers/bootstrap.min.css')); ?>" rel="stylesheet">
<link href="<?php echo e(URL::asset('css/movers/style.css')); ?>" rel="stylesheet">
<!--------Fonts--------------->
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600" rel="stylesheet">
<link href="<?php echo e(URL::asset('css/movers/font-awesome.min.css')); ?>" rel="stylesheet">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" style="display:none;">
          <div class="container-fluid">
            <div class="navbar-header">
              <a class="navbar-brand" href="#"><img src="<?php echo e(url('/') . '/images/logo.png'); ?>" alt="Udistro" /></a>
            </div>
              <ul class="nav navbar-nav navbar-right navbar-top-link">
                <li><a href="#"><i><img src="<?php echo e(url('/') . '/images/truck.png'); ?>" /></i> <span><u>For Business</u></span></a></li>
...
<script src="<?php echo e(URL::asset('js/movers/bootstrap.js')); ?>"></script> 
<script>
 $(function() {
